...
const DocumentEditor: React.FC = () => {
    ...
    function circleAction(points: { x: number; y: number }[]) {
        ...
        console.log(`Drew highlight at x=${x}, y=${y}`);
    }
        ...
        >
            ...
            {commentBox?.visible && (
                <div
                    style={{
                        position: 'absolute',
                        top: commentBox.y + commentBox.height + 10,
                        left: commentBox.x,
                ...
                >
                    ...
                    <div style={{ marginTop: '8px', textAlign: 'right' }}>
                        <button
                            onClick={() => {
                                console.log('[Comment Saved]', commentBox?.value);
                                setCommentBox(null); // Hide the comment box
                            }}
                        >
                            Save
                        </button>
